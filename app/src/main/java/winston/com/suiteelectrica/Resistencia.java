                ...
                new NavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        switch (menuItem.getItemId()) {
                            case R.id.inicio:
                                Intent ini = new Intent(Resistencia.this, MainActivity.class);
                                startActivity(ini);
                                finish();
                            ...
                            case R.id.sugerencias:
                                Intent ayu = new Intent(Resistencia.this, Sugerencia.class);
                                startActivity(ayu);
                                finish();
                                break;
                            case R.id.colabore:
                                Intent inf = new Intent(Resistencia.this, ColaboreConNosotros.class);
                                startActivity(inf);
                                finish();
                                break;
                            case R.id.acercade:
                                Intent acer = new Intent(Resistencia.this, SobreNosotros.class);
                                startActivity(acer);
                                finish();
                                break;
                            case R.id.deltaestrella:
                                Intent del = new Intent(Resistencia.this, DeltaEstrella.class);
                                startActivity(del);
                                finish();
                                break;
                            case R.id.leydeohm:
                                Intent ley = new Intent(Resistencia.this, LeydeOhm.class);
                                startActivity(ley);
                                finish();
                                break;
                            case R.id.calpotencia:
                                Intent pot = new Intent(Resistencia.this, Potencia.class);
                                startActivity(pot);
                                finish();
                                break;
                            case R.id.informacion:
                                Intent infor = new Intent(Resistencia.this, informacion.class);
                                startActivity(infor);
                                finish();
                                break;
        ...
        aceptar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (r1.getText().length()==0 || r2.getText().length()==0 ){
                    Toast.makeText(Resistencia.this, "Rellene los campos vacios", Toast.LENGTH_SHORT).show();
                    ...
                    res.setText("La Resistencia es: "+resu+" Ω");
